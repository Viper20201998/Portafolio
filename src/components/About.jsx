      ...
      <section className='row container-fluid justify-content-center my-lg-4 '>
        <article className='col-md-4'>
          ...
          <p className='main-section__p'>
            I am a Network and Information Systems Engineer - I live in El
            Salvador in the city of San Miguel. I have been creating web
            development projects during the bootcamp to specialize in FrontEnd
            and BackEnd.
          </p>
        </article>
